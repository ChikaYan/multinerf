...
workdir="/rds/project/rds-qxpdOeYWi78/multinerf"  # The value of SLURM_SUBMIT_DIR sets workdir to the directory
...
# SCAN=110
# SCAN=37
DATA_DIR="/rds/project/rds-qxpdOeYWi78/plenoxels/data/dtu/dtu_scan$SCAN"
